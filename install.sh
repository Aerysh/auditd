...
24.04)
  LIBAUPARSE_PKG="./packages/libauparse0t64_3.1.2-2.1build1_amd64.deb"
  AUDITD_PKG="./packages/auditd_3.1.2-2.1build1_amd64.deb"
  ;;
22.04)
  LIBAUPARSE_PKG="./packages/libauparse0_3.0.7-1build1_amd64.deb"
  AUDITD_PKG="./packages/auditd_3.0.7-1build1_amd64.deb"
  ;;
20.04)
  LIBAUPARSE_PKG="./packages/libauparse0_2.8.5-2ubuntu6_amd64.deb"
  AUDITD_PKG="./packages/auditd_2.8.5-2ubuntu6_amd64.deb"
  ;;
18.04)
  LIBAUPARSE_PKG="./packages/libauparse0_2.8.2-1ubuntu1_amd64.deb"
  AUDITD_PKG="./packages/auditd_2.8.2-1ubuntu1_amd64.deb"
  ;;
16.04)
  LIBAUPARSE_PKG="./packages/libauparse0_2.4.5-1ubuntu2_amd64.deb"
  AUDITD_PKG="./packages/auditd_2.4.5-1ubuntu2_amd64.deb"
  ;;
*)
...
AUDIT_RULES_FILE="./rules/auditd.conf"
